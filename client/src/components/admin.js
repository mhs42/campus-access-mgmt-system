...
export default function App() {
    ...
    const userColumns = [
        ...
        },
        {
          ...
          key: "key",
          render: (text, record) => (
            <button data-index={[record.username,record.state]} onClick={reg}>change</button>
           ),
        },
        {
          title: "delete",
          ...
          key: "key",
          render: (text, record) => (
            <button data-index={[record.username]} onClick={regg}>delete</button>
           ),
        },
        {
            title: "TAs",
            ...
            key: "key",
            render: (text, record) => (
                <button data-index={[record.username]} onClick={regg1}>TAs</button>
               ),
        },
        {
            title: "facility",
            ...
            key: "key",
            render: (text, record) => (
                <button data-index={[record.username]} onClick={reggg1}>facility</button>
               ),
        }
      ];
